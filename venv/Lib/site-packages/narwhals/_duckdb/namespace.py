...
class DuckDBNamespace(LazyNamespace[DuckDBLazyFrame, DuckDBExpr, duckdb.DuckDBPyRelation]):
    ...
    def concat(self, items: Iterable[DuckDBLazyFrame], *, how: ConcatMethod) -> DuckDBLazyFrame:
    ...
    def lit(self, value: NonNestedLiteral, dtype: DType | type[DType] | None) -> DuckDBExpr:
...
class DuckDBThen(CompliantThen["DuckDBLazyFrame", duckdb.Expression, DuckDBExpr], DuckDBExpr): ...
