...
class IbisLazyFrame:
    ...
    def __init__(self, df: Any, *, backend_version: tuple[int, ...], version: Version) -> None:
    ...
    def _with_native(self, df: Any) -> Self:
        return self.__class__(df, version=self._version, backend_version=self._backend_version)
