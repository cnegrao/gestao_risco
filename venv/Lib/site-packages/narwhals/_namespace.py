...
if TYPE_CHECKING:
    ...
    _NativeSparkLike: TypeAlias = "_NativeSQLFrame | _NativePySpark | _NativePySparkConnect"

    NativeKnown: TypeAlias = (
        "_NativePolars | _NativeArrow | _NativePandasLike | _NativeSparkLike | _NativeDuckDB | _NativeDask"
    )
    NativeUnknown: TypeAlias = "NativeFrame | NativeSeries | NativeLazyFrame | DataFrameLike"
...
class Namespace(Generic[CompliantNamespaceT_co]):
    ...
    @classmethod
    def from_backend(cls: type[Namespace[Any]], backend: IntoBackend, /) -> Namespace[Any]:
    ...
    @overload
    @classmethod
    def from_native_object(cls, native: _NativePolars, /) -> Namespace[PolarsNamespace]: ...

    @overload
    @classmethod
    def from_native_object(cls, native: _NativePandasLike, /) -> Namespace[PandasLikeNamespace]: ...
    ...
    @overload
    @classmethod
    def from_native_object(cls, native: _NativeSparkLike, /) -> Namespace[SparkLikeNamespace]: ...

    @overload
    @classmethod
    def from_native_object(cls, native: _NativeDuckDB, /) -> Namespace[DuckDBNamespace]: ...
    ...
    @overload
    @classmethod
    def from_native_object(cls, native: NativeUnknown, /) -> Namespace[CompliantNamespaceAny]: ...

    @classmethod
    def from_native_object(cls: type[Namespace[Any]], native: NativeAny, /) -> Namespace[Any]:
...
def is_native_arrow(obj: Any) -> TypeIs[_NativeArrow]:
    return (pa := get_pyarrow()) is not None and isinstance(obj, (pa.Table, pa.ChunkedArray))
...
def is_native_pandas_like(obj: Any) -> TypeIs[_NativePandasLike]:
    return is_native_pandas(obj) or is_native_cudf(obj) or is_native_modin(obj)  # pragma: no cover


def is_native_spark_like(obj: Any) -> TypeIs[_NativeSparkLike]:
    return is_native_sqlframe(obj) or is_native_pyspark(obj) or is_native_pyspark_connect(obj)
