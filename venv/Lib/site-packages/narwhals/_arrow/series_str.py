...
class ArrowSeriesStringNamespace(ArrowSeriesNamespace):
    ...
    def strip_chars(self, characters: str | None) -> ArrowSeries:
        return self.with_native(pc.utf8_trim(self.native, characters or string.whitespace))
    ...
    def ends_with(self, suffix: str) -> ArrowSeries:
        return self.with_native(pc.equal(self.slice(-len(suffix), None).native, lit(suffix)))
    ...
    def slice(self, offset: int, length: int | None) -> ArrowSeries:
        ...
        return self.with_native(pc.utf8_slice_codeunits(self.native, start=offset, stop=stop))
