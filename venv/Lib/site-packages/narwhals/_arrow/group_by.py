...
class ArrowGroupBy(EagerGroupBy["ArrowDataFrame", "ArrowExpr"]):
    ...
    def agg(self, *exprs: ArrowExpr) -> ArrowDataFrame:
        ...
        for expr in exprs:
            ...
            aggs.extend([(output_name, function_name, option) for output_name in output_names])
    ...
    def __iter__(self) -> Iterator[tuple[Any, ArrowDataFrame]]:
        col_token = generate_temporary_column_name(n_bytes=8, columns=self.compliant.columns)
