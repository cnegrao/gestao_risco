...
class ArrowNamespace(
    ...
    def len(self) -> ArrowExpr:
        ...
        return self._expr(  # pragma: no cover
            lambda df: [ArrowSeries.from_iterable([len(df.native)], name="len", context=self)],
            depth=0,
            function_name="len",
    ...
    def lit(self, value: NonNestedLiteral, dtype: DType | type[DType] | None) -> ArrowExpr:
        def _lit_arrow_series(_: ArrowDataFrame) -> ArrowSeries:
            arrow_series = ArrowSeries.from_iterable(data=[value], name="literal", context=self)
            if dtype:
    ...
    def concat_str(
        ...
        *exprs: ArrowExpr,
        ...
        def func(df: ArrowDataFrame) -> list[ArrowSeries]:
            ...
            null_handling: Literal["skip", "emit_null"] = "skip" if ignore_nulls else "emit_null"
