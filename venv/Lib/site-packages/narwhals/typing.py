...
PivotAgg: TypeAlias = Literal["min", "max", "first", "last", "sum", "mean", "median", "len"]
...
RollingInterpolationMethod: TypeAlias = Literal["nearest", "higher", "lower", "midpoint", "linear"]
...
NonNestedLiteral: TypeAlias = "NumericLiteral | TemporalLiteral | str | bool | bytes | None"
