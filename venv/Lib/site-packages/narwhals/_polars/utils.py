...
if TYPE_CHECKING:
    ...
    T = TypeVar("T")
    NativeT = TypeVar("NativeT", bound="pl.DataFrame | pl.LazyFrame | pl.Series | pl.Expr")
...
def native_to_narwhals_dtype(
    ...
    if isinstance_or_issubclass(dtype, pl.Duration):
        return dtypes.Duration() if dtype is pl.Duration else dtypes.Duration(dtype.time_unit)
    ...
    if isinstance_or_issubclass(dtype, pl.List):
        return dtypes.List(native_to_narwhals_dtype(dtype.inner, version, backend_version))
...
def narwhals_to_native_dtype(
    ...
    if isinstance_or_issubclass(dtype, dtypes.Array):  # pragma: no cover
        ...
        return pl.Array(narwhals_to_native_dtype(dtype.inner, version, backend_version), **kwargs)
...
def catch_polars_exception(
    ...
    elif backend_version < (1,) and "polars.exceptions" in str(type(exception)):  # pragma: no cover
