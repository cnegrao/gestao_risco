...
class PolarsSeries:
    ...
    def __narwhals_namespace__(self) -> PolarsNamespace:
        ...
        return PolarsNamespace(backend_version=self._backend_version, version=self._version)
    ...
    def _with_version(self, version: Version) -> Self:
        return self.__class__(self.native, backend_version=self._backend_version, version=version)
    ...
    def from_iterable(
        ...
        *,
        ...
        dtype_pl = narwhals_to_native_dtype(dtype, version, backend_version) if dtype else None
    ...
    def _with_native(self, series: pl.Series) -> Self:
        return self.__class__(series, backend_version=self._backend_version, version=self._version)
    ...
    def dtype(self) -> DType:
        return native_to_narwhals_dtype(self.native.dtype, self._version, self._backend_version)
    ...
    def ewm_mean(
        ...
        *,
        ...
        if self._backend_version < (1,):  # pragma: no cover
            return self._with_native(
                pl.select(pl.when(~self.native.is_null()).then(native_result).otherwise(None))[
                    self.native.name
                ]
            )
    ...
    def rolling_sum(
        ...
        *,
        ...
        return self._with_native(
            self.native.rolling_sum(window_size=window_size, center=center, **extra_kwargs)
        )
    ...
    def rolling_mean(
        ...
        *,
        ...
        return self._with_native(
            self.native.rolling_mean(window_size=window_size, center=center, **extra_kwargs)
        )
        ...
        if self._backend_version < (1, 0, 0):
            ...
            result = self.native.value_counts(sort=sort, parallel=parallel).select(
                **{
                    ...
                    value_name_: (
                        pl.col("count") / pl.sum("count") if normalize else pl.col("count")
                    ),
                }
            )
        else:
    ...
    def hist(
        ...
        *,
        ...
        if (self._backend_version < (1, 15)) and (bin_count is not None):  # pragma: no cover
...
class PolarsSeriesListNamespace:
    ...
    def __getattr__(self, attr: str) -> Any:  # pragma: no cover
        def func(*args: Any, **kwargs: Any) -> Any:
            pos, kwds = extract_args_kwargs(args, kwargs)
            return self._series._with_native(getattr(self._series.native.list, attr)(*pos, **kwds))
