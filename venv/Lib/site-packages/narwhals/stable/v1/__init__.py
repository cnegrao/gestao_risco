...
class Series(NwSeries[IntoSeriesT]):
    ...
    def __init__(self, series: Any, *, level: Literal["full", "lazy", "interchange"]) -> None:
...
def _stableify(
    obj: NwDataFrame[IntoFrameT] | NwLazyFrame[IntoFrameT] | NwSeries[IntoSeriesT] | NwExpr | Any,
...
@overload
def from_native(native_object: DataFrameT | LazyFrameT, **kwds: Any) -> DataFrameT | LazyFrameT: ...
