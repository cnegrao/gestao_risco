...
NativeFrameT_contra = TypeVar("NativeFrameT_contra", bound="NativeFrame", contravariant=True)
...
CompliantExprT_contra = TypeVar("CompliantExprT_contra", bound=CompliantExprAny, contravariant=True)
CompliantSeriesT = TypeVar("CompliantSeriesT", bound=CompliantSeriesAny)
CompliantSeriesT_co = TypeVar("CompliantSeriesT_co", bound=CompliantSeriesAny, covariant=True)
...
CompliantFrameT_co = TypeVar("CompliantFrameT_co", bound=CompliantFrameAny, covariant=True)
...
EvalSeries: TypeAlias = Callable[[CompliantFrameT], Sequence[CompliantSeriesOrNativeExprT]]
