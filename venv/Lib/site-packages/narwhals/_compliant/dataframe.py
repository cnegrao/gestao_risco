...
class CompliantDataFrame(
    ...
    def to_dict(self, *, as_series: bool) -> dict[str, CompliantSeriesT] | dict[str, list[Any]]: ...
    def unique(
        self,
...
class CompliantLazyFrame(
    ...
    def explode(self, columns: Sequence[str]) -> Self: ...
    def filter(self, predicate: CompliantExprT_contra | Incomplete) -> Self: ...
    @deprecated("`LazyFrame.gather_every` is deprecated and will be removed in a future version.")
    def gather_every(self, n: int, offset: int) -> Self: ...
    def group_by(
        self,
        keys: Sequence[str] | Sequence[CompliantExprT_contra],
...
class EagerDataFrame(
    ...
    def _evaluate_into_expr(self, expr: EagerExprT, /) -> Sequence[EagerSeriesT]:
        ...
        result = expr(self)
        if list(aliases) != (result_aliases := [s.name for s in result]):  # pragma: no cover
    ...
    @staticmethod
    def _numpy_column_names(data: _2DArray, columns: Sequence[str] | None, /) -> list[str]:
    ...
    def _select_multi_index(self, columns: SizedMultiIndexSelector[NativeSeriesT]) -> Self: ...
    def _select_multi_name(self, columns: SizedMultiNameSelector[NativeSeriesT]) -> Self: ...
