...
class CompliantExpr(Protocol38[CompliantFrameT, CompliantSeriesOrNativeExprT_co]):
    ...
    def __call__(self, df: CompliantFrameT) -> Sequence[CompliantSeriesOrNativeExprT_co]: ...
...
class EagerExpr(
    ...
    def _reuse_series_extra_kwargs(self, *, returns_scalar: bool = False) -> dict[str, Any]:
        return {}
    ...
    def clip(
        ...
        return self._reuse_series("clip", lower_bound=lower_bound, upper_bound=upper_bound)
    ...
    def fill_null(
        ...
        return self._reuse_series("fill_null", value=value, strategy=strategy, limit=limit)
    ...
    def replace_strict(
        ...
        *,
        ...
        return self._reuse_series("replace_strict", old=old, new=new, return_dtype=return_dtype)
    ...
    def map_batches(
        ...
        def func(df: EagerDataFrameT) -> Sequence[EagerSeriesT]:
            ...
            if is_numpy_array(result[0]) or (
                ...
                from_numpy = partial(self.__narwhals_namespace__()._series.from_numpy, context=self)
                result = [
...
class EagerExprDateTimeNamespace(
    ...
    def timestamp(self, time_unit: TimeUnit) -> EagerExprT:
        return self.compliant._reuse_series_namespace("dt", "timestamp", time_unit=time_unit)
...
class CompliantExprNameNamespace(  # type: ignore[misc]
    ...
    def _from_callable(self, func: AliasName, /, *, alias: bool = True) -> CompliantExprT_co: ...
...
class EagerExprStringNamespace(
    ...
    def strip_chars(self, characters: str | None) -> EagerExprT:
        return self.compliant._reuse_series_namespace("str", "strip_chars", characters=characters)
    ...
    def slice(self, offset: int, length: int | None) -> EagerExprT:
        return self.compliant._reuse_series_namespace("str", "slice", offset=offset, length=length)
...
class EagerExprStructNamespace(
    ...
    def field(self, name: str) -> EagerExprT:
        return self.compliant._reuse_series_namespace("struct", "field", name=name).alias(name)
