...
class CompliantNamespace(Protocol[CompliantFrameT, CompliantExprT]):
    ...
    def col(self, *column_names: str) -> CompliantExprT:
        return self._expr.from_column_names(passthrough_column_names(column_names), context=self)
    ...
    def lit(self, value: NonNestedLiteral, dtype: DType | type[DType] | None) -> CompliantExprT: ...
    ...
    def concat(self, items: Iterable[CompliantFrameT], *, how: ConcatMethod) -> CompliantFrameT: ...
    def when(
...
class DepthTrackingNamespace(
    ...
    def all(self) -> DepthTrackingExprT:
        return self._expr.from_column_names(get_column_names, function_name="all", context=self)
...
class EagerNamespace(
    ...
    def _concat_horizontal(self, dfs: Sequence[NativeFrameT | Any], /) -> NativeFrameT: ...
    def _concat_vertical(self, dfs: Sequence[NativeFrameT], /) -> NativeFrameT: ...
    def concat(self, items: Iterable[EagerDataFrameT], *, how: ConcatMethod) -> EagerDataFrameT:
