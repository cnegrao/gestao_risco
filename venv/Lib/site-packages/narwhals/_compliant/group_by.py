...
class DepthTrackingGroupBy(
    ...
    @classmethod
    def _remap_expr_name(cls, name: NarwhalsAggregation | Any, /) -> NativeAggregationT_co:
...
class LazyGroupBy(
    ...
    def _evaluate_expr(self, expr: LazyExprT_contra, /) -> Iterator[NativeExprT_co]:
        ...
        aliases = (
            expr._alias_output_names(output_names) if expr._alias_output_names else output_names
        )
    ...
    def _evaluate_exprs(self, exprs: Iterable[LazyExprT_contra], /) -> Iterator[NativeExprT_co]:
        for expr in exprs:
