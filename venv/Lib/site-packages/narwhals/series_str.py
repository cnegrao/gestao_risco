...
class SeriesStringNamespace(Generic[SeriesT]):
    ...
    def replace(self, pattern: str, value: str, *, literal: bool = False, n: int = 1) -> SeriesT:
    ...
    def replace_all(self, pattern: str, value: str, *, literal: bool = False) -> SeriesT:
        ...
        """
        return self._narwhals_series._with_compliant(
            self._narwhals_series._compliant_series.str.replace_all(pattern, value, literal=literal)
        )
    ...
    def slice(self, offset: int, length: int | None = None) -> SeriesT:
        ...
        """
        return self._narwhals_series._with_compliant(
            self._narwhals_series._compliant_series.str.slice(offset=offset, length=length)
        )
