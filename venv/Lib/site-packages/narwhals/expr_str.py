...
class ExprStringNamespace(Generic[ExprT]):
    ...
    def replace(self, pattern: str, value: str, *, literal: bool = False, n: int = 1) -> ExprT:
    ...
    def contains(self, pattern: str, *, literal: bool = False) -> ExprT:
        ...
        """
        return self._expr.__class__(
            lambda plx: self._expr._to_compliant_expr(plx).str.contains(pattern, literal=literal),
            self._expr._metadata,
        )
    ...
    def slice(self, offset: int, length: int | None = None) -> ExprT:
        ...
        """
        return self._expr.__class__(
            lambda plx: self._expr._to_compliant_expr(plx).str.slice(offset=offset, length=length),
            self._expr._metadata,
        )
    ...
    def tail(self, n: int = 5) -> ExprT:
        ...
        """
        return self._expr.__class__(
            lambda plx: self._expr._to_compliant_expr(plx).str.slice(offset=-n, length=None),
            self._expr._metadata,
        )
