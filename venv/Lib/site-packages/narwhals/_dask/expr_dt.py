...
class DaskExprDateTimeNamespace:
    ...
    def month(self) -> DaskExpr:
        return self._compliant_expr._with_callable(lambda _input: _input.dt.month, "month")
    ...
    def minute(self) -> DaskExpr:
        return self._compliant_expr._with_callable(lambda _input: _input.dt.minute, "minute")

    def second(self) -> DaskExpr:
        return self._compliant_expr._with_callable(lambda _input: _input.dt.second, "second")
    ...
    def replace_time_zone(self, time_zone: str | None) -> DaskExpr:
        return self._compliant_expr._with_callable(
            lambda _input, time_zone: (
                _input.dt.tz_localize(None).dt.tz_localize(time_zone)
    ...
    def convert_time_zone(self, time_zone: str) -> DaskExpr:
        ...
        return self._compliant_expr._with_callable(func, "tz_convert", time_zone=time_zone)
