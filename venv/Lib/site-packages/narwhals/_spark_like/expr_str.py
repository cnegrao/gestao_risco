...
class SparkLikeExprStringNamespace:
    ...
    def strip_chars(self, characters: str | None) -> SparkLikeExpr:
        ...
        def func(_input: Column) -> Column:
            ...
            return self._compliant_expr._F.btrim(_input, self._compliant_expr._F.lit(to_remove))
    ...
    def contains(self, pattern: str, *, literal: bool) -> SparkLikeExpr:
        def func(_input: Column) -> Column:
            contains_func = (
                self._compliant_expr._F.contains if literal else self._compliant_expr._F.regexp
            )
    ...
    def slice(self, offset: int, length: int | None) -> SparkLikeExpr:
        ...
        def func(_input: Column) -> Column:
            ...
            _length = self._compliant_expr._F.lit(length) if length is not None else col_length
    ...
    def to_datetime(self, format: str | None) -> SparkLikeExpr:
        ...
        if not format:
            ...
            function = partial(F.to_timestamp_ntz, format=F.lit(strptime_to_pyspark_format(format)))
        else:
