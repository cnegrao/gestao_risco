...
def _is_into_schema(obj: Any) -> TypeIs[_IntoSchema]:
    ...
    return obj is None or isinstance(obj, (Mapping, Schema)) or is_sequence_but_not_str(obj)
...
def sum_horizontal(*exprs: IntoExpr | Iterable[IntoExpr]) -> Expr:
    ...
    return Expr(
        lambda plx: apply_n_ary_operation(plx, plx.sum_horizontal, *flat_exprs, str_as_lit=False),
...
def min_horizontal(*exprs: IntoExpr | Iterable[IntoExpr]) -> Expr:
    ...
    flat_exprs = flatten(exprs)
    return Expr(
        lambda plx: apply_n_ary_operation(plx, plx.min_horizontal, *flat_exprs, str_as_lit=False),
        ExprMetadata.from_horizontal_op(*flat_exprs),
    )
...
def max_horizontal(*exprs: IntoExpr | Iterable[IntoExpr]) -> Expr:
    ...
    flat_exprs = flatten(exprs)
    return Expr(
        lambda plx: apply_n_ary_operation(plx, plx.max_horizontal, *flat_exprs, str_as_lit=False),
        ExprMetadata.from_horizontal_op(*flat_exprs),
    )
...
def all_horizontal(*exprs: IntoExpr | Iterable[IntoExpr]) -> Expr:
    ...
    flat_exprs = flatten(exprs)
    return Expr(
        lambda plx: apply_n_ary_operation(plx, plx.all_horizontal, *flat_exprs, str_as_lit=False),
        ExprMetadata.from_horizontal_op(*flat_exprs),
    )
...
def any_horizontal(*exprs: IntoExpr | Iterable[IntoExpr]) -> Expr:
    ...
    flat_exprs = flatten(exprs)
    return Expr(
        lambda plx: apply_n_ary_operation(plx, plx.any_horizontal, *flat_exprs, str_as_lit=False),
        ExprMetadata.from_horizontal_op(*flat_exprs),
    )
...
def mean_horizontal(*exprs: IntoExpr | Iterable[IntoExpr]) -> Expr:
    ...
    flat_exprs = flatten(exprs)
    return Expr(
        lambda plx: apply_n_ary_operation(plx, plx.mean_horizontal, *flat_exprs, str_as_lit=False),
        ExprMetadata.from_horizontal_op(*flat_exprs),
    )
...
def concat_str(
    ...
    *more_exprs: IntoExpr,
    ...
    return Expr(
        lambda plx: apply_n_ary_operation(
            plx,
            lambda *args: plx.concat_str(*args, separator=separator, ignore_nulls=ignore_nulls),
            *flat_exprs,
            str_as_lit=False,
        ),
        combine_metadata(
