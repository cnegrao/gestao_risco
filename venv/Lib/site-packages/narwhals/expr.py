...
if TYPE_CHECKING:
    ...
    PS = ParamSpec("PS")
    R = TypeVar("R")
    _ToCompliant: TypeAlias = Callable[[CompliantNamespace[Any, Any]], CompliantExpr[Any, Any]]
...
class Expr:
    ...
    def _with_aggregation(self, to_compliant_expr: Callable[[Any], Any]) -> Self:
        ...
        return self.__class__(to_compliant_expr, self._metadata.with_kind(ExprKind.AGGREGATION))

    def _with_order_dependent_aggregation(self, to_compliant_expr: Callable[[Any], Any]) -> Self:
        if self._metadata.kind.is_scalar_like():
            msg = "Aggregations can't be applied to scalar-like expressions."
            raise InvalidOperationError(msg)
        return self.__class__(
    ...
    def _with_filtration(self, to_compliant_expr: Callable[[Any], Any]) -> Self:
        if self._metadata.kind.is_scalar_like():
            ...
            raise InvalidOperationError(msg)
        return self.__class__(to_compliant_expr, self._metadata.with_kind(ExprKind.FILTRATION))
    ...
    def _taxicab_norm(self) -> Self:
        ...
        return self._with_aggregation(lambda plx: self._to_compliant_expr(plx).abs().sum())
    ...
    def __pow__(self, other: Any) -> Self:
        return self.__class__(
            lambda plx: apply_n_ary_operation(plx, lambda x, y: x**y, self, other, str_as_lit=True),
            ExprMetadata.from_binary_op(self, other),
        )
    ...
    def std(self, *, ddof: int = 1) -> Self:
        ...
        Examples:
            ...
            └─────────────────────┘
        """
        return self._with_aggregation(lambda plx: self._to_compliant_expr(plx).std(ddof=ddof))
    ...
    def var(self, *, ddof: int = 1) -> Self:
        ...
        Examples:
            ...
            └───────────────────────┘
        """
        return self._with_aggregation(lambda plx: self._to_compliant_expr(plx).var(ddof=ddof))
    ...
    def is_in(self, other: Any) -> Self:
        ...
        if isinstance(other, Iterable) and not isinstance(other, (str, bytes)):
            return self._with_callable(
                lambda plx: self._to_compliant_expr(plx).is_in(to_native(other, pass_through=True)),
            )
        else:
    ...
    def drop_nulls(self) -> Self:
        ...
        Examples:
            ...
            └──────────────────┘
        """
        return self._with_filtration(lambda plx: self._to_compliant_expr(plx).drop_nulls())
    ...
    def over(
        ...
        *partition_by: str | Sequence[str],
        ...
        return self.__class__(
            lambda plx: self._to_compliant_expr(plx).over(flat_partition_by, flat_order_by),
            next_meta,
        )
    ...
    def null_count(self) -> Self:
        ...
        Examples:
            ...
            └──────────────────┘
        """
        return self._with_aggregation(lambda plx: self._to_compliant_expr(plx).null_count())
    ...
    def round(self, decimals: int = 0) -> Self:
        ...
        Examples:
            ...
            └──────────────────────┘
        """
        return self._with_callable(lambda plx: self._to_compliant_expr(plx).round(decimals))
    ...
    def rank(self, method: RankMethod = "average", *, descending: bool = False) -> Self:
        ...
        return self._with_callable(
            lambda plx: self._to_compliant_expr(plx).rank(method=method, descending=descending)
        )
