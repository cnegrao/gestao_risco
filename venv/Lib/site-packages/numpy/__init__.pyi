...
_RealArrayT = TypeVar(
    "_RealArrayT", bound=NDArray[floating[Any] | integer[Any] | timedelta64 | np.bool | object_]
)
...
_NumberItemT_co = TypeVar(
    "_NumberItemT_co", bound=int | float | complex, default=int | float | complex, covariant=True
)
...
class dtype(Generic[_SCT_co], metaclass=_DTypeMeta):
    ...
    def fields(
        ...
        None | MappingProxyType[LiteralString, tuple[dtype[Any], int] | tuple[dtype[Any], int, Any]]
    ): ...
    @property
    def flags(self) -> int: ...
    @property
...
class _ArrayOrScalarCommon:
    ...
    def argmax(
        self, /, axis: SupportsIndex | None, out: _ArrayT, *, keepdims: builtins.bool = False
    ) -> _ArrayT: ...
    @overload
    def argmax(
        self, /, axis: SupportsIndex | None = None, *, out: _ArrayT, keepdims: builtins.bool = False
    ) -> _ArrayT: ...
    @overload  # axis=None (default), out=None (default), keepdims=False (default)
    def argmin(
        self, /, axis: None = None, out: None = None, *, keepdims: L[False] = False
...
class ndarray(_ArrayOrScalarCommon, Generic[_ShapeT_co, _DType_co]):
    ...
    @overload
    def __divmod__(
        self: NDArray[floating[_64Bit]], rhs: _ArrayLikeFloat64_co, /
    ...
    @overload
    def __rdivmod__(
        self: NDArray[floating[_64Bit]], lhs: _ArrayLikeFloat64_co, /
    ) -> _2Tuple[NDArray[float64]]: ...
    @overload
    def __rdivmod__(
    ...
    @overload
    def __truediv__(
        self: _ArrayInt_co | NDArray[floating[_64Bit]], other: _ArrayLikeFloat64_co, /
    ) -> NDArray[float64]: ...
    @overload
    def __truediv__(
...
class matrix(ndarray[_2DShapeT_co, _DType_co]):
    ...
    @overload
    def std(
        self, axis: None = ..., dtype: DTypeLike = ..., out: None = ..., ddof: float = ...
    ) -> Any: ...
    @overload
    def std(
        self, axis: _ShapeLike, dtype: DTypeLike = ..., out: None = ..., ddof: float = ...
    ) -> matrix[_2D, Any]: ...
    @overload
    def std(
        self,
