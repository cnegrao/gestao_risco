...
def MakeSimpleProtoClass(fields, full_name=None, pool=None):
    ...
    if full_name is None:
        full_name = (
            "net.proto2.python.public.proto_builder.AnonymousProto_" + fields_hash.hexdigest()
        )
        try:
            proto_cls = _GetMessageFromFactory(pool_instance, full_name)
            return proto_cls
    ...
    pool_instance.Add(_MakeFileDescriptorProto(proto_file_name, full_name, field_items))
